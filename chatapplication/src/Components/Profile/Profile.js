    ...
    return (
      <Grid container component='main' className='root'>
        ...
        >
          ...
          >
            <button className='btnhome'>Profile</button>
          </Card>
          <div style={paper}>
            <img
              className='avatar'
            ...
            <div className='viewWrapInputFile'>
              <img
                ...
                alt='icon gallery'
                src='https://firebasestorage.googleapis.com/v0/b/chat-app-72544.appspot.com/o/ic_input_file.png?alt=media&token=87d9f557-abf5-44fe-8f74-2ab3cdd68b4c'
                onClick={() => {
                  this.refInput.click();
                }}
              />
